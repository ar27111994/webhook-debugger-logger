...
describe('Common Utils', () => {
    ...
    describe('deepRedact', () => {
        ...
        it('should redact sensitive keys', () => {
            const obj = { password: PASSWORD_VAL, apiKey: SENSITIVE_VAL, other: 'value' };
        ...
        it('should redact nested keys', () => {
            ...
            expect(obj).toEqual({ auth: { token: LOG_CONSTS.CENSOR_MARKER }, meta: { id: 1 } });
        });
        ...
        it('should handle arrays of objects using explicit paths', () => {
            ...
            expect(obj).toEqual({ items: [{ secret: LOG_CONSTS.CENSOR_MARKER }, { secret: LOG_CONSTS.CENSOR_MARKER }] });
        });
    ...
    describe('validateUUID', () => {
        it('should return true for valid UUID v4', () => {
            ...
            expect(validateUUID('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', UUID_V4_LENGTH)).toBe(true);
        });
