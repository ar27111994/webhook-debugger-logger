/**
 * @file tests/unit/middleware/middleware_auth.test.js
...
describe("Auth Middleware", () => {
  ...
  describe("createAuthMiddleware", () => {
    ...
    it("should call validateAuth and if invalid, call sendUnauthorizedResponse", () => {
      ...
      authMock.validateAuth.mockReturnValue({
        isValid: false,
        error: authError,
      });
      ...
      expect(routeUtilsMock.sendUnauthorizedResponse).toHaveBeenCalledWith(
        mockReq,
        mockRes,
        { error: authError },
      );
