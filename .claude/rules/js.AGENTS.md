---
description: Apify Actors Development Guide (JS)
paths:
  - "**/*.js"
  - "**/*.json"
  - "**/*.html"
...
- [Input/Output Schema](js.INPUT_OUTPUT_SCHEMAS.md) (Input validation, Console form, Output templates)
- [Storage Schema](js.STORAGE_SCHEMAS.md) (Dataset and Key-Value Store specifications)
